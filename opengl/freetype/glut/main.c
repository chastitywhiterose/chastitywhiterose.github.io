/*standard library and opengl header section*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
glReadPixels(0,0,width,height,GL_RGBA,GL_UNSIGNED_BYTE,fontimage);

 gl_putstr("Chastity",200,100);
 gl_putstr("White",200,200);
 gl_putstr("Rose",200,300);

glDrawPixels(width,height,GL_RGBA,GL_UNSIGNED_BYTE,fontimage);
...
{
 chastity_freetype_begin();
 
  printf("Chastity White Rose FreeType example\n");
 ...
 glutCreateWindow("Chastity's OpenGL FreeType program!");
